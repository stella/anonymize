...
//!
//! Mirrors `Dictionaries` in `types.ts`. Maps use `BTreeMap` for deterministic
...
pub struct Dictionaries {
  ...
  pub first_names: Option<BTreeMap<String, Vec<String>>>,
  /// Surnames per language code.
  pub surnames: Option<BTreeMap<String, Vec<String>>>,
  /// Non-Western name tokens per locale code.
  pub non_western_names: Option<BTreeMap<String, Vec<String>>>,
  /// Deny-list dictionaries keyed by dictionary ID.
  pub deny_list: Option<BTreeMap<String, Vec<String>>>,
  /// Metadata per dictionary ID.
  pub deny_list_meta: Option<BTreeMap<String, DictionaryMeta>>,
  /// City names already merged across countries.
  pub cities: Option<Vec<String>>,
  /// City names keyed by ISO 3166-1 alpha-2 country code.
  pub cities_by_country: Option<BTreeMap<String, Vec<String>>>,
}
