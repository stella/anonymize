...
class PreparedSessionRedactionPlan:
...
def extract_docx_text_json(document: BytesLike) -> str: ...
def inspect_pdf_json(
    document: BytesLike,
    observations_json: str | None = None,
) -> str: ...
def rewrite_docx_text_native(
    document: BytesLike,
    rewrites_json: str,
) -> tuple[bytes, int, int]: ...
def prepare_docx_anonymized_export_native(
    document: BytesLike,
) -> tuple[bytes, str, str]: ...
def finalize_docx_anonymized_export_native(document: BytesLike) -> bytes: ...
def plan_docx_restoration_json(document: BytesLike, session_id: str) -> str: ...
