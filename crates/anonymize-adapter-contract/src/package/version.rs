...
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_HEADER: [u8; 8] =
  *b"ANONCPZ1";
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_VERSION: u32 = 32;
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_ZSTD_VERSION: u32 = 33;
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_PAYLOAD_DIGEST_VERSION: u32 = 34;
