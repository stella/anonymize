...
pub(crate) const PREPARED_SEARCH_PACKAGE_VERSION: u32 = 21;
pub(crate) const PREPARED_SEARCH_COMPRESSED_PACKAGE_HEADER: [u8; 8] =
  *b"ANONPKZ1";
pub(crate) const PREPARED_SEARCH_COMPRESSED_PACKAGE_VERSION: u32 = 31;
pub(crate) const PREPARED_SEARCH_COMPRESSED_PACKAGE_ZSTD_VERSION: u32 = 32;
...
pub(crate) const PREPARED_SEARCH_CORE_PACKAGE_VERSION: u32 = 27;
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_HEADER: [u8; 8] =
  *b"ANONCPZ1";
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_VERSION: u32 = 35;
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_ZSTD_VERSION: u32 = 36;
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_PAYLOAD_DIGEST_VERSION: u32 = 37;
