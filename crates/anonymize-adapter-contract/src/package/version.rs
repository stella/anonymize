...
pub(crate) const PREPARED_SEARCH_PACKAGE_VERSION: u32 = 18;
pub(crate) const PREPARED_SEARCH_COMPRESSED_PACKAGE_HEADER: [u8; 8] =
  *b"ANONPKZ1";
pub(crate) const PREPARED_SEARCH_COMPRESSED_PACKAGE_VERSION: u32 = 22;
pub(crate) const PREPARED_SEARCH_COMPRESSED_PACKAGE_ZSTD_VERSION: u32 = 23;
...
pub(crate) const PREPARED_SEARCH_CORE_PACKAGE_VERSION: u32 = 25;
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_HEADER: [u8; 8] =
  *b"ANONCPZ1";
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_VERSION: u32 = 29;
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_ZSTD_VERSION: u32 = 30;
pub(crate) const PREPARED_SEARCH_CORE_COMPRESSED_PACKAGE_PAYLOAD_DIGEST_VERSION: u32 = 31;
